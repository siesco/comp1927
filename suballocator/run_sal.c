//
// COMP1927 Assignment 1 - Memory Suballocator test driver
// sal_run.c ... test the memory suballocator
//
...
int main(int argc, char *argv[])
{
   ...
   while (fgets(line, BUFSIZ, stdin) != NULL) {
      ...
      if (sscanf(line, "+ %[a-z] %d", &var, &val) == 2) {
         // set a pointer variable using sal_malloc()
         if (ptr[var-'a'] != NULL)
